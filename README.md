...
5. イベント開始
    * 主旨説明、自己紹介、チーム分けなどが終わったら、いよいよイベントの開始です。チーム分けされた ...
    * 下記URLや過去のHackathonのスケジュールを参照してつくる。
        * Hackathon in a box: https://sites.google.com/site/hackathoninabox/
        * 日本語版: https://sites.google.com/site/devreljp/Home/hackathon-in-a-box
6. ...

<a name="followup"> イベント後のフォローアップ
----------------------------------------------
...
<!--
<a name="comments"> 執筆コメント
--------------------------------

* このガイドラインを誰でも合議のうえ編集可能なようにGitHubなどにあげておくのはどうか（鎌田）
* 「はじめてのハッカソン」みたいな中高生向けの簡単なバージョンがあってもいいかも（佐伯）
-->